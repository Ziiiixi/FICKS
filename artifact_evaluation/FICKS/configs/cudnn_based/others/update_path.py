...
CONFIG_DIR = Path("/home/zixi/orion_bu/artifact_evaluation/FICKS/configs/cudnn_based/others")

# Directory where the kernel CSV files live (these files may NOT end with .csv)
KERNEL_DIR = Path("/home/zixi/orion_bu/benchmarking/model_kernels/cudnn_based/others")

# Set this for all entries
TARGET_NUM_ITERS = 110

# Map arch -> (kernel file basename, num_kernels)
ARCH_INFO: Dict[str, Tuple[str, int]] = {
    "resnet152":    ("resnet152_8_fwd", 513),
    "resnet101":    ("resnet101_8_fwd", 343),
    "densenet201":  ("densenet201_8_fwd", 705),
    "vgg19":        ("vgg19_8_fwd", 56),
    "mobilenet_v2": ("mobilenet_v2_32_fwd", 150),
