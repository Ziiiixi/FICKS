...
CONFIG_DIR = Path("/home/zixi/orion_bu/artifact_evaluation/FICKS/configs/cudnn_based/ficks")

# Directory where the kernel CSV files live (these files may NOT end with .csv)
KERNEL_DIR = Path("/home/zixi/orion_bu/benchmarking/model_kernels/cudnn_based/ficks")
