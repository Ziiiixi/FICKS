...
def create_config(net, number):
    ...
    if "Mnet" in net:
        return {
            "arch": "mobilenet_v2",
            "kernel_file": f"/home/zixi/orion_bu/benchmarking/model_kernels/ours/mobilenetv2_{batch_size}_fwd",
        ...
        return {
            ...
            "kernel_file": f"/home/zixi/orion_bu/benchmarking/model_kernels/ours/resnet152_{batch_size}_fwd",
            "num_kernels": kernel_counts[net],
            "num_iters": 20,
            "args": {
        ...
        return {
            ...
            "kernel_file": f"/home/zixi/orion_bu/benchmarking/model_kernels/ours/resnet101_{batch_size}_fwd",
            "num_kernels": kernel_counts[net],
            "num_iters": 20,
            "args": {
        ...
        return {
            ...
            "kernel_file": f"/home/zixi/orion_bu/benchmarking/model_kernels/ours/vgg19_{batch_size}_fwd",
            "num_kernels": kernel_counts[net],
            "num_iters": 20,
            "args": {
                "model_name": "vgg19",
        ...
        return {
            ...
            "kernel_file": f"/home/zixi/orion_bu/benchmarking/model_kernels/ours/densenet201_{batch_size}_fwd",
            "num_kernels": kernel_counts[net],
            "num_iters": 20,
            "args": {
        ...
        return {
            ...
            "kernel_file": f"/home/zixi/orion_bu/benchmarking/model_kernels/ours/vitb16_{batch_size}_fwd",
            "num_kernels": kernel_counts[net],
            "num_iters": 20,
            "args": {
                "model_name": "vit_b_16",
        ...
        return {
            ...
            "kernel_file": f"/home/zixi/orion_bu/benchmarking/model_kernels/ours/bert_{batch_size}_fwd",
            "num_kernels": kernel_counts[net],
            "num_iters": 20,
            "args": {
                "model_name": "bert",
